...
import com.example.FootbalLeague.service.TokenService;
...
public class MailServiceImpl implements MailService {
    ...
    @Autowired
    public MailServiceImpl(final TokenService tokenService, final PlayerService playerService) {
     ...
     *
     * @param mail the mail with specified attributes of {@link Mail}
     */
    @Override
    ...
    public void sendResetMail(final String emailAddress) {
        final Token token = tokenService.generateToken(playerService.findPlayerByeMail(emailAddress));
